...
@Component({
  selector: 'app-doer-profile-notification-settings',
  templateUrl: './doer-profile-notification-settings.component.html',
  styleUrls: ['./doer-profile-notification-settings.component.scss']
})
export class DoerProfileNotificationSettingsComponent implements OnInit {
  @Input()
  isControltHidden;
  profile_details: any = [];
  user_id: any;
