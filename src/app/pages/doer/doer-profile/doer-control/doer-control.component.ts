...
@Component({
  selector: 'app-doer-control',
  templateUrl: './doer-control.component.html',
  styleUrls: ['./doer-control.component.scss']
})
export class DoerControlComponent implements OnInit {
