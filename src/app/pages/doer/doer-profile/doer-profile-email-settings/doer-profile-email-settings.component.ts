...
declare var $;
@Component({
  selector: 'app-doer-profile-email-settings',
  templateUrl: './doer-profile-email-settings.component.html',
  styleUrls: ['./doer-profile-email-settings.component.scss']
})
export class DoerProfileEmailSettingsComponent implements OnInit {
  @Input()
  isControltHidden;
  profile_details: any = [];
  user_id: any;
