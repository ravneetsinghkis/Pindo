...
@Component({
  selector: 'app-doer-support',
  templateUrl: './doer-support.component.html',
  styleUrls: ['./doer-support.component.scss']
})
export class DoerSupportComponent implements OnInit {
  ...
  ongetUserDetailsSuccess(response) {
    if (response.status == 1 && response.data.user_type == 2) {
      this.userDetail = response.data;
      // this.pinner_support.patchValue({
