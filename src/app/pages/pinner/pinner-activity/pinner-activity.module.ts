...
import { routing } from './pinner-activity.routing';
...
@NgModule({
  ...
  exports: [PinnerActivityComponent],
  declarations: [PinnerActivityComponent, CourseDialogComponent, EscapeHtmlPipe, InviteGuestComponent, ArchiveConfirmationComponent],
...
export class PinnerActivityModule { 
