...
export class EmailSettingsComponent implements OnInit {
  ...
  onSave() {
    ...
    let data = [
      ...
      { 'comment_email': this.responseVal },
      { 'likes_email': this.responseVal },
      ...
      { 'first_name': this.currentPrivacyDetails.first_name },
      { 'last_name': this.currentPrivacyDetails.last_name },
      { 'profile_photo': this.currentPrivacyDetails.profile_photo },
      { 'primary_address': this.currentPrivacyDetails.primary_address },
      { 'bio': this.currentPrivacyDetails.bio },
      { 'interest': this.currentPrivacyDetails.interest },
      { 'contacts': this.currentPrivacyDetails.contacts },
    ];
