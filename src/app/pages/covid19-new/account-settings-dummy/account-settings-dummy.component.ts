...
@Component({
  selector: 'app-account-settings-dummy',
  templateUrl: './account-settings-dummy.component.html',
  styleUrls: ['./account-settings-dummy.component.scss']
})
export class AccountSettingsDummyComponent implements OnInit {
